          ...
          <div className="mt-10 ">
            ...
            {links.map((item)=>(
              ...
              <div key={item.title}>
                ...
                {item.links.map((link)=>(
                  <NavLink onClick={handlecloseSidebar} key={link.name} to={`/${link.to}`} style={({isActive})=> ({backgroundColor:isActive ? currentColor : ""})} className={({isActive})=> isActive ? activelink : normallink}>
